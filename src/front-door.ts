...
import { CommunityHelloWorld } from "./hello-world/v1";
...
export const publisher: MosaicTemplatePublisherDescriptor = {
  ...
  description:
    "The community repo itself — the front door card carrying the Community M, re-baked on every release. Contributor templates ship under their own publisher handle.",
  entryModule: "./dist/front-door.js",
};

/** The one card. Deliberately not extensible: this handle owns the door. */
export const templates = [CommunityHelloWorld];
