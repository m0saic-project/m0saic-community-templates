 ...
 * standalone).
 */
export declare function buildTypingTimeline(words: string[], timing: TypingTimingSpec, endBehavior: SearchTypingEndBehavior, options?: BuildTypingTimelineOptions): TypingTimeline;
