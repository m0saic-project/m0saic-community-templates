...
exports.renderLyricVideoCover = renderLyricVideoCover;
...
function coverHero(theme, type) {
    const line = (0, template_utils_1.onboardingLeaf)((0, template_utils_1.onboardingTextSource)({
    ...
    const nextLine = (0, template_utils_1.onboardingLeaf)((0, template_utils_1.onboardingTextSource)({
    ...
    const frame = (0, template_utils_1.onboardingOverlay)((0, template_utils_1.onboardingSolid)("#000000"), (0, template_utils_1.onboardingSplit)("row", [6, 3, 1, 2, 4], [null, line, null, nextLine, null]));
    const cueStrip = (0, template_utils_1.onboardingSplit)("col", [4, 10, 4], [
        null,
    ...
    return (0, template_utils_1.onboardingFrame)((0, template_utils_1.onboardingSplit)("row", [15, 1, 2], [frame, null, cueStrip]), theme.borderStrong);
}
/** Production cover: the family chat pane beside the lyric-frame hero. */
function renderLyricVideoCover(ctx) {
    return (0, template_utils_1.buildBrandedCover)({
        ctx,
        copy: {
            productName: "Lyric Video",
            title: "Lyrics, on time.",
            overview: "Turn a song and its lyrics into a finished lyric video — line-timed text over your backdrop, the render exactly as long as the track.",
