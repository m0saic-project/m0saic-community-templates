...
exports.SEEDED_TERRITORY_PROFILES = void 0;
exports.placeholderBadgeSources = placeholderBadgeSources;
const template_utils_1 = require("@m0saic/template-utils");
const profile = (value) => value;
exports.SEEDED_TERRITORY_PROFILES = {
    US: profile({
...
function placeholderBadgeSources(certification, color = "#111111") {
    const text = {
        type: "text",
        rasterizer: "svg",
    ...
    const base = (0, template_utils_1.makeColorTile)(color);
