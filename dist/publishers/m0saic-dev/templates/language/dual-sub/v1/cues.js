...
exports.prepareCues = prepareCues;
const HTML_TAG = /<[^>]+>/g;
...
function sanitizeCueText(raw, opts) {
    const lines = raw
        .replace(HTML_TAG, "")
        ...
        let l = line;
        if (opts.stripSdh) {
            if (SDH_DESCRIPTOR_LINE.test(l) || l.includes("♪"))
                return "";
