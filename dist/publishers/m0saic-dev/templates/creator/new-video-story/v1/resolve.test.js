...
describe("resolveNewVideoStory", () => {
    ...
    it("colour knobs: blank falls back to the preset / stage default", () => {
        expect((0, resolve_1.resolveColor)("", "#ABCDEF")).toBe("#ABCDEF");
        expect((0, resolve_1.resolveColor)("  ", "#ABCDEF")).toBe("#ABCDEF");
        expect((0, resolve_1.resolveColor)(" #123456 ", "#ABCDEF")).toBe("#123456");
    ...
    it("screenshot knobs: fit narrows, focus / corner clamp, audio defaults on", () => {
        ...
        expect(cfgOf({ mediaFit: "stretch" }).cfg.mediaFit).toBe("cover");
...
describe("classifyMedia", () => {
    it("the probe wins; else the extension; else image", () => {
        expect((0, resolve_1.classifyMedia)("x.png", "video")).toBe("video");
        expect((0, resolve_1.classifyMedia)("x.mp4", "image")).toBe("image");
        expect((0, resolve_1.classifyMedia)("clip.MOV", undefined)).toBe("video");
        expect((0, resolve_1.classifyMedia)("shot.webp", undefined)).toBe("image");
        expect((0, resolve_1.classifyMedia)("https://cdn/x.mp4?sig=1", undefined)).toBe("video");
    });
});
