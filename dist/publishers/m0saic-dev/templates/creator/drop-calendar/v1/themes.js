...
exports.CALENDAR_THEME_NAMES = void 0;
exports.isCalendarThemeName = isCalendarThemeName;
exports.resolveCalendarTheme = resolveCalendarTheme;
exports.CALENDAR_THEME_NAMES = [
    "studio",
    "classic",
    "noir",
    "valentine",
...
function isCalendarThemeName(v) {
    return typeof v === "string" && exports.CALENDAR_THEME_NAMES.includes(v);
}
/**
 * Resolve theme tokens: named theme, with optional per-role overrides (empty
 * strings mean "keep the theme's value").
 */
function resolveCalendarTheme(name, overrides) {
